        ...
        <>
            <div className="bg-cover bg-center bg-fixed" style={{backgroundImage: 'url(' + Yoga7 + ')'}}>
                <section className="h-screen flex items-center">
                    <div className="text">
                        <h1 className="text-9xl mb-8 text-white font-black uppercase">Alignment Yoga</h1>
                        <h5 className="text-7xl mb-8 text-white font-black uppercase">(I drivhus el. under åben himmel)</h5>
                    </div>
                </section>
